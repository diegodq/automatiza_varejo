import { Column, CreateDateColumn, Entity, JoinColumn, OneToMany, ManyToOne, PrimaryGeneratedColumn, UpdateDateColumn, ManyToMany } from "typeorm";
...
class Customer
{
	...
	@ManyToMany(() => Permission, permission => permission.customer)
