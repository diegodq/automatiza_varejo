...
export class default1689277619139 implements MigrationInterface {
    name = 'default1689277619139'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`company_product\` (\`product_id\` int NOT NULL, \`company_id\` int NOT NULL, INDEX \`IDX_b7ff2469c7bdb14114f75e5453\` (\`product_id\`), INDEX \`IDX_2f92209ad6a5ea9f41dbb3cee6\` (\`company_id\`), PRIMARY KEY (\`product_id\`, \`company_id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`company_product\` ADD CONSTRAINT \`FK_b7ff2469c7bdb14114f75e54539\` FOREIGN KEY (\`product_id\`) REFERENCES \`company\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE \`company_product\` ADD CONSTRAINT \`FK_2f92209ad6a5ea9f41dbb3cee67\` FOREIGN KEY (\`company_id\`) REFERENCES \`product\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`company_product\` DROP FOREIGN KEY \`FK_2f92209ad6a5ea9f41dbb3cee67\``);
        await queryRunner.query(`ALTER TABLE \`company_product\` DROP FOREIGN KEY \`FK_b7ff2469c7bdb14114f75e54539\``);
        ...
        await queryRunner.query(`DROP INDEX \`IDX_2f92209ad6a5ea9f41dbb3cee6\` ON \`company_product\``);
        await queryRunner.query(`DROP INDEX \`IDX_b7ff2469c7bdb14114f75e5453\` ON \`company_product\``);
