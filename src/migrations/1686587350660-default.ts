...
export class default1686587350660 implements MigrationInterface {
    name = 'default1686587350660'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`params_questions\` (\`id\` int NOT NULL AUTO_INCREMENT, \`tree_question\` tinyint NULL, \`option_one\` varchar(80) NULL, \`option_two\` varchar(80) NULL, \`import_type\` varchar(15) NULL, \`position\` int NULL, \`passing_tree\` int NULL, \`mandatory_question\` tinyint NULL, \`finish_research\` tinyint NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`question_id\` int NULL, UNIQUE INDEX \`REL_9aa79f2a7894b704ec14a133ae\` (\`question_id\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`question\` (\`id\` int NOT NULL AUTO_INCREMENT, \`title_question\` varchar(100) NULL, \`question_description\` varchar(100) NULL, \`type_question\` varchar(20) NOT NULL, \`status\` tinyint NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`company_id\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`params_product\` (\`id\` int NOT NULL AUTO_INCREMENT, \`background_color\` varchar(20) NULL, \`font_color\` varchar(20) NULL, \`anchor_question\` varchar(100) NULL, \`product_id\` int NULL, UNIQUE INDEX \`REL_b88bda1fd370ae7dbc95761d25\` (\`product_id\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`product\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(180) NOT NULL, \`description\` varchar(180) NOT NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`company_id\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`product\` ADD CONSTRAINT \`FK_a0503db1630a5b8a4d7deabd556\` FOREIGN KEY (\`company_id\`) REFERENCES \`company\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
