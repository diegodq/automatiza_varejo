...
export class default1686078847158 implements MigrationInterface {
    name = 'default1686078847158'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`question\` (\`id\` int NOT NULL AUTO_INCREMENT, \`title_question\` varchar(100) NULL, \`question_description\` varchar(100) NULL, \`status\` tinyint NULL, \`tree_question\` varchar(10) NOT NULL, \`type_question\` varchar(20) NOT NULL, \`option_one\` varchar(80) NULL, \`option_two\` varchar(80) NULL, \`import_type\` varchar(15) NULL, \`position\` int NULL, \`mandatory_question\` tinyint NULL, \`finish_research\` tinyint NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`company_id\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`company\` (\`id\` int NOT NULL AUTO_INCREMENT, \`corporate_name\` varchar(255) NOT NULL, \`fantasy_name\` varchar(255) NOT NULL, \`logo_company\` varchar(255) NULL, \`cnpj\` varchar(20) NOT NULL, \`zip_code\` varchar(17) NOT NULL, \`state\` varchar(17) NOT NULL, \`address\` varchar(255) NOT NULL, \`number\` varchar(20) NOT NULL, \`complement\` varchar(255) NULL, \`district\` varchar(200) NOT NULL, \`city\` varchar(200) NOT NULL, \`anchor_question\` varchar(100) NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`customer_id\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
