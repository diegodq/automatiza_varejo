...
export class default1685383734441 implements MigrationInterface {
    name = 'default1685383734441'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`question\` (\`id\` int NOT NULL AUTO_INCREMENT, \`title_question\` varchar(100) NULL, \`question_description\` varchar(100) NULL, \`status\` tinyint NULL, \`tree_question\` varchar(10) NOT NULL, \`anchor_question\` varchar(100) NULL, \`type_question\` varchar(20) NOT NULL, \`option_one\` varchar(80) NULL, \`option_two\` varchar(80) NULL, \`import_type\` varchar(15) NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`company_id\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
