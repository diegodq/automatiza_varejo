...
export class default1687834677330 implements MigrationInterface {
    name = 'default1687834677330'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`params_product\` (\`id\` int NOT NULL AUTO_INCREMENT, \`background_color\` varchar(20) NULL, \`font_color\` varchar(20) NULL, \`anchor_question\` varchar(100) NULL, \`passing_tree\` int NULL, \`product_id\` int NULL, UNIQUE INDEX \`REL_b88bda1fd370ae7dbc95761d25\` (\`product_id\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
