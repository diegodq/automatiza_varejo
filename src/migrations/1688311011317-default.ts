...
export class default1688311011317 implements MigrationInterface {
    name = 'default1688311011317'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`product\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(180) NOT NULL, \`description\` varchar(180) NOT NULL, \`anchor_question\` varchar(100) NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`product_company\` (\`product_id\` int NOT NULL, \`company_id\` int NOT NULL, INDEX \`IDX_c1587431f770a425a41faaa86a\` (\`product_id\`), INDEX \`IDX_3ef1fe843a1a2bd21f5c3e9801\` (\`company_id\`), PRIMARY KEY (\`product_id\`, \`company_id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`product_company\` ADD CONSTRAINT \`FK_c1587431f770a425a41faaa86aa\` FOREIGN KEY (\`product_id\`) REFERENCES \`product\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE \`product_company\` ADD CONSTRAINT \`FK_3ef1fe843a1a2bd21f5c3e98018\` FOREIGN KEY (\`company_id\`) REFERENCES \`company\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`product_company\` DROP FOREIGN KEY \`FK_3ef1fe843a1a2bd21f5c3e98018\``);
        await queryRunner.query(`ALTER TABLE \`product_company\` DROP FOREIGN KEY \`FK_c1587431f770a425a41faaa86aa\``);
        ...
        await queryRunner.query(`DROP INDEX \`IDX_3ef1fe843a1a2bd21f5c3e9801\` ON \`product_company\``);
        await queryRunner.query(`DROP INDEX \`IDX_c1587431f770a425a41faaa86a\` ON \`product_company\``);
        await queryRunner.query(`DROP TABLE \`product_company\``);
